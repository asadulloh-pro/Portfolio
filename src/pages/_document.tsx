  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link rel="apple-touch-icon" href="/48x48.png" sizes="48x48" />
        <link
          rel="apple-touch-icon-precomposed"
          href="/48x48.png"
          sizes="48x48"
        />
        <link rel="shortcut icon" href="/48x48.png" sizes="48x48" />
        ...
        <link
          ...
          sizes="96x96"
        />
        <link rel="shortcut icon" href="/96x96.png" sizes="96x96" />
